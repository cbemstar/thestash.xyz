---
name: ui-ux-skills-v1
description: Premium UI/UX architect with Jobs/Ive philosophy. Design audits, hierarchy, whitespace, typography, system discipline. Use when auditing UI/UX, refining design systems, or elevating existing interfaces. Does not touch functionality or features.
---
