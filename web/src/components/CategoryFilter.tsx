  ...
  return (
    ...
    >
      <button
        ...
        className="shrink-0 rounded-full border border-white/20 bg-white/5 px-4 py-2 text-sm font-medium transition-colors duration-200 hover:border-white/30 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background motion-reduce:transition-none"
        style={{
          backgroundColor: value === "all" ? "rgb(var(--accent) / 0.2)" : undefined,
      ...
      {CATEGORIES.map(({ value: catValue, label }) => (
        <button
          ...
          className="shrink-0 rounded-full border border-white/20 bg-white/5 px-4 py-2 text-sm font-medium transition-colors duration-200 hover:border-white/30 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background motion-reduce:transition-none"
          style={{
            backgroundColor: value === catValue ? "rgb(var(--accent) / 0.2)" : undefined,
